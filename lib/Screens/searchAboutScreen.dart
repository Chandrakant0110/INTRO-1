  ...
  void didChangeDependencies() {
    ...
    if (!dataPresent) {
      Database().getCurrentUserGroup().then((value) {
        ...
        // print();
        detailList = describeUserData(currentUserData!['user_group']+" ${currentUserData!['Gender']}");
        // print(detailList);
        setState(() {});
      });
    }
...
class ProfileWidget extends StatefulWidget {
  ...
  @override
  State<ProfileWidget> createState() => _ProfileWidgetState(data);
}

class _ProfileWidgetState extends State<ProfileWidget> {
  int selectedindex = 0;
  Map<String, dynamic> data = {};
  _ProfileWidgetState(this.data);
